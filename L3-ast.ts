...
;;         |  ( let* ( binding* ) <cexp>+ ) / LetStarExp(bindings:Binding[], body: CExp[])    ADDED NOW!!!!
...
export type CompoundExp = AppExp | IfExp | ProcExp | LetExp | LetStarExp | LitExp;      //added LetStarExp assignment 2
...
// L3
export interface LetStarExp {tag: "LetStarExp"; bindings: Binding[]; body: CExp[]; };           //ADDED ASSIGNMENT 2
